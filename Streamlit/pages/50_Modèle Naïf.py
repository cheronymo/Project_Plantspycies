...
#         ['train_acc', 'val_acc', 'test_F1'], axis=0).highlight_min(['train_param', 'epochs'], axis=0), width=5000)

#     # st.subheader('Tous ces modèles ont été entrainés lancés sur 20 epochs')
